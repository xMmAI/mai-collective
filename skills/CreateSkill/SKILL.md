...
**Before creating ANY skill, READ:** `$MAI_DIR/skills/CORE/SkillSystem.md`
...
1. **Read the spec:** `$MAI_DIR/skills/CORE/SkillSystem.md`
2. **Create directory:** `$MAI_DIR/skills/SkillName/`
...
```bash
bun run $MAI_DIR/Tools/validate-pack.ts
```
...
→ Create $MAI_DIR/skills/Recipes/SKILL.md
