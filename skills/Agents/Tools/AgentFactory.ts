...
// Paths - adjust MAI_DIR as needed
const MAI_DIR = process.env.MAI_DIR || `${process.env.HOME}/.config/pai`;
const TRAITS_PATH = `${MAI_DIR}/skills/Agents/Data/Traits.yaml`;
const TEMPLATE_PATH = `${MAI_DIR}/skills/Agents/Templates/DynamicAgent.hbs`;
