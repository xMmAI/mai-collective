...
**Location:** `$MAI_DIR/skills/Browser/Tools/Browse.ts`

### screenshot - Take a screenshot

```bash
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts screenshot <url> [output-path]
```

**Examples:**
```bash
# Screenshot to default location
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts screenshot https://danielmiessler.com

# Screenshot to specific file
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts screenshot https://example.com /tmp/example.png
```

### verify - Check element exists

```bash
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts verify <url> <selector>
```

**Examples:**
```bash
# Verify body exists
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts verify https://example.com "body"

# Verify specific element
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts verify https://danielmiessler.com "h1"

# Verify by CSS selector
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts verify https://example.com ".main-content"
```

### open - Open URL in visible browser

```bash
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts open <url>
```

**Examples:**
```bash
# Open site for manual inspection
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts open https://danielmiessler.com
```
...
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts screenshot https://example.com/changed-page /tmp/verify.png

# 2. Verify the specific element that changed
bun run $MAI_DIR/skills/Browser/Tools/Browse.ts verify https://example.com/changed-page ".changed-element"
```
