...
| **MAI Blue** | `#4a90d9` | 74, 144, 217 | Key elements, primary accents, main structures |
...
- **MAI Blue**: 15-20% (key components, primary accents)
...
- Color: MAI Blue `#4a90d9` or Electric Cyan `#22d3ee`
...
- [ ] MAI Blue (`#4a90d9`) for key elements
