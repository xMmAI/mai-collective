...
4. **Strategic color** - MAI Blue #4a90d9 for key elements, Cyan #22d3ee for flows
...
- Color: MAI Blue `#4a90d9` or Cyan `#22d3ee`
...
MAI Blue     #4a90d9    - Key components, insights (15-20%)
...
- INSIGHTS: Condensed italic, MAI Blue #4a90d9, used for callouts with asterisks
...
Include 1-3 insight callouts like "*key insight here*" in MAI Blue.

COLOR USAGE:
- White #e5e7eb for all text and primary structure
- MAI Blue #4a90d9 for key components and insights
...
```bash
bun run $MAI_DIR/skills/Art/Tools/Generate.ts \
...
- [ ] 1-3 insight callouts in MAI Blue
...
| No insights | Add "include 1-3 callouts in MAI Blue" |
