...
## ACTIONABLE RULES FOR ALL AGENTS (read this first)

This is the working reference. Apply every rule below to every piece of content produced in this pipeline. The full Wikipedia source material follows as background reading.

---

### 1. No em dashes

Em dashes ( — ) are one of the clearest signals that content was AI-written. Readers notice. Editors notice. Do not use them.

**Replace with the correct punctuation instead:**

| Instead of | Use |
|---|---|
| "X — and Y" (light pause) | comma: "X, and Y" |
| "X — Y is the reason" (introducing explanation) | colon: "X: Y is the reason" |
| "X — but Y" (contrasting clauses) | semicolon or new sentence: "X; but Y" / "X. But Y." |
| "X — not Y" (clarification) | comma or parentheses: "X, not Y" |
| Bullet label "**Feature** — description" | colon: "**Feature:** description" |
| Heading "Title — subtitle" | colon: "Title: Subtitle" |

If removing an em dash makes the sentence feel awkward, rewrite the sentence. Don't patch it with another dash.

---

### 2. No AI puffery words

Never use these words or phrases. They are statistically common in AI output and signal generic, inflated writing:

**Significance inflation:** stands as, serves as, is a testament to, is a reminder that, pivotal, crucial, vital, key role, key moment, underscores, highlights its importance, reflects broader, symbolizing its enduring, contributing to the, setting the stage for, marking a shift, key turning point, evolving landscape, focal point, indelible mark, deeply rooted

**Promotional inflation:** boasts, vibrant, rich (used figuratively), profound, enhancing its, showcasing, exemplifies, commitment to, groundbreaking (figurative), renowned, nestled, in the heart of, testament to, at the forefront

**Vague attribution:** Industry reports suggest, Observers have noted, Experts argue, Some critics say, Many believe, It is widely acknowledged

---

### 3. No trailing "-ing" analysis phrases

AI writing habitually adds meaning or analysis at the end of sentences using present participles. Cut them.

**Bad:** "The platform shut down, leaving thousands of bakers scrambling and highlighting the fragility of small business software."
**Good:** "The platform shut down, leaving thousands of bakers scrambling."

Watch for: ensuring, fostering, reflecting, highlighting, underscoring, emphasising, showcasing, enabling, allowing, demonstrating, reinforcing, contributing, creating, building, driving, shaping — when tacked onto the end of a sentence to add commentary.

---

### 4. No vague superlatives without proof

Every strong claim needs a specific fact behind it.

**Bad:** "BakeSuite is incredibly powerful and easy to use."
**Good:** "BakeSuite costs AU $22/month and includes AI recipe import, inventory management, and Stripe payments."

The more specific, the more credible. Liars generalise; truth-tellers have details.

---

### 5. No hollow transitions and filler openers

Cut these opening patterns — they add nothing and read as AI:
...
Start sentences with the actual point.

---

### 6. Vary sentence structure

AI defaults to similar sentence lengths and patterns throughout a piece. Human writers mix it up.

- Short sentences hit hard. Use them.
- Longer sentences with subordinate clauses can build context, add nuance, and carry the reader through a more complex idea without losing them.
- Questions work. Do you have 300 recipes you don't want to re-enter?
- Don't start every paragraph with a noun + verb. Change it up.

---

### 7. No "not only... but also"

This construction is heavily overused in AI writing. Avoid it entirely.

---

### 8. No excessive bolding

AI bolds random phrases for emphasis. Only bold items that are genuinely scannable reference points (feature names, product names, pricing, key terms). Do not bold full sentences or conclusions.

---

### 9. Write to one person, not a crowd

Use "you," not "bakers" or "users" or "people." The reader is one person. Speak to them directly.

**Bad:** "Home bakers often struggle with pricing their products."
**Good:** "If you've ever undercharged for a cake and only realised halfway through making it, you know exactly what this feels like."

---

### 10. Specificity over generality — always

Replace generic statements with concrete details.

| Generic (AI) | Specific (Human) |
|---|---|
| "many bakers" | "thousands of Bake Diary users" |
| "affordable pricing" | "AU $22/month" |
| "easy to use" | "no credit card, up and running in an afternoon" |
| "great for small businesses" | "built for home bakers running custom cake orders" |

---

*Full Wikipedia reference on AI writing patterns follows below.*
